...
public class BaktiAlamCottage {
    public static void main(String[] args) {
        ...
        System.out.println("-=Bakti Alam Cottage=-\n------------------------\nCottage yang tersedia :\n1. Duku\n  ->2 ruangan\n2. Jeruk\n  ->2 ruangan\n3. Alpukat\n  ->1 ruangan" +
                "\n4. Jambu_Air\n  ->1 ruangan\n5. Durian\n  ->2 ruangan\n6. Melon\n  ->2 ruangan\n7. Belimbing\n  ->2 ruangan\n8. Mangga\n  ->2 ruangan" +
                "\n9. Kedondong\n  ->2 ruangan\n10. Barrack\n  ->Perorang\n------------------------\nMasukkan nama cottage yang anda pilih (spasi gunakan "+"_"+"): ");
        ...
        harga = switch (cottage) {
            ...
            case "alpukat","jambu_air" -> hari.equals("weekdays") ?  575000 : hari.equals("weekend") ? 695000 : hari.equals("holiday") ? 895000 : 0;
